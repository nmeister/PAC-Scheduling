...
function wasClicked_Alg(type)
{
  schedule_wasClicked = document.getElementById('schedule_button').getAttribute('clicked');

  if(schedule_wasClicked=='false' && (type == "schedule")) { 
  ...
  else if (type=='schedule')
  {
    ...
    document.getElementById('schedule_button').setAttribute('clicked', 'false');
    document.getElementById('delete_button').setAttribute('clicked', 'true');
    return true;
  }  
  // change was clicked to false
  else if (schedule_wasClicked=='true' && (type == "delete")) {
    console.log('was clicked and now imma delete');
    document.getElementById('delete_button').setAttribute('clicked', 'false');
    document.getElementById('schedule_button').setAttribute('clicked', 'true');
    return true;
  }
